    ...
    public static class Utilities
    {
        ...
        public static LabelSettings GetSettings(DocumentType documentType)
        {
            switch (documentType)
            {
                ...
                case DocumentType.LabelSettings_Avery_5960:
                    return new LabelSettings_Avery_5960();
                case DocumentType.LabelSettings_Avery_8167:
                    return new LabelSettings_Avery_8167();
                default:
